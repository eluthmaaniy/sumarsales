...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sumar Network Service — Shopify Partner Expert" },
      {
        name: "description",
        content:
          "Sumar Network Service — Shopify Partner expert helping store owners build, redesign, and scale profitable Shopify stores.",
      },
    ],
